...
This vignette demonstrates how to use the functions in this package to estimate marginal Cox proportional hazards models for clustered interval-censored data, incorporating time-dependent covariates and stratification. The methodology is based on the composite likelihood framework developed in [Cook et al.](https://pubmed.ncbi.nlm.nih.gov/36314377/) (2023)
